<?php 
	...
	$query = "INSERT INTO conductor VALUES (NULL, '$email', MD5('$psw'), '$AP', '$AM', '$nombre' , NULL, '$tel', '$ruta', '$delegacion', '$cp', '$hora1', '', '', '', '', NULL, NULL, '', '', '', '')";
	if($_POST['dia2']!=0){
	$dia2 = $_POST['dia2']; $hora2 = $_POST['hora2'];
	$query = "INSERT INTO conductor VALUES (NULL, '$email', MD5('$psw'), '$AP', '$AM', '$nombre' , NULL, '$tel', '$ruta', '$delegacion', '$cp', '$hora1', '$hora2', '', '', '', NULL, NULL, '', '', '', '')";
	}
	if($_POST['dia3']!=0){
	$dia3 = $_POST['dia3']; $hora3 = $_POST['hora3'];
	$query = "INSERT INTO conductor VALUES (NULL, '$email', MD5('$psw'), '$AP', '$AM', '$nombre' , NULL, '$tel', '$ruta', '$delegacion', '$cp', '$hora1', '$hora2', '$hora3', '', '', NULL, NULL, '', '', '', '')";
	}
	if($_POST['dia4']!=0){
	$dia4 = $_POST['dia4']; $hora4 = $_POST['hora4'];
	$query = "INSERT INTO conductor VALUES (NULL, '$email', MD5('$psw'), '$AP', '$AM', '$nombre' , NULL, '$tel', '$ruta', '$delegacion', '$cp', '$hora1', '$hora2', '$hora3', '$hora4', '', NULL, NULL, '', '', '', '')";
	}
	if($_POST['dia5']!=0){
	$dia5 = $_POST['dia5']; $hora5 = $_POST['hora5'];
	$query = "INSERT INTO conductor VALUES (NULL, '$email', MD5('$psw'), '$AP', '$AM', '$nombre' , NULL, '$tel', '$ruta', '$delegacion', '$cp', '$hora1', '$hora2', '$hora3', '$hora4', '$hora5', NULL, NULL, '', '', '', '')";
	}
	...
	$query2 = "INSERT INTO auto VALUES (NULL, '$numDP', '$placa','$marca','$modelo','$color')";
