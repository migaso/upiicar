...
<?php  }
		$correo = $_COOKIE['user'];
		$query = "SELECT * FROM conductor, auto WHERE (conductor.CorrInstitu_Conductor='$correo')";
		    ...
		    <div class="row profile">
				...
				<div class="col-md-9">
		            <div id="info1" class="profile-content verperf">
					   ...
					   <?php  echo $row['ApPaterno_Conductor'].' '.$row['ApMaterno_Conductor'].' '.$row['Nombre_Conductor']; ?>
					   <h3>TELEFONO:</h3>
					   <?php echo $row['Tel_Conductor']; ?>
		            </div>

		            <div id="info2" class="profile-content busocult">
					   <h3>COCHE</h3>
					   <center>
					   <p>Número de Asientos:<?php echo $row['NoAsientos_Auto']; ?><br>
					   Número de Placas:<?php echo $row['NoPlacas_Auto']; ?><br>
					   Marca:<?php echo $row['Marca_Auto']; ?><br>
					   Modelo:<?php echo $row['Modelo_Auto']; ?><br>
					   Color:<?php echo $row['Color_Auto']; ?></p>
		            ...
		            <div id="info3" class="profile-content compocult">
					   ...
					   <center><?php echo $row['Ruta'];?></center>
